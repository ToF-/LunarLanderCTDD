...
console: $(SRC_FILES) mock_controller
	$(C_COMPILER) $(CFLAGS) $(INC_DIRS) $(SYMBOLS) $(SRC_FILES) mock_controller.o -o console $(shell pkg-config allegro-5 allegro_main-5 allegro_font-5 --libs --cflags) -lallegro_main -lallegro_ttf
	./console
